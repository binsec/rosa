...
struct Cli {
    ...
    #[arg(long_help, value_name = "TRACE 1", help = "Path tgo first trace")]
...
fn run(
    ...
    let trace_1 = load_trace_from_file(
        "trace_1",
        trace_1_path,
        &trace_1_path.with_extension("trace"),
    )?;

    let trace_2 = load_trace_from_file(
        "trace_2",
        trace_2_path,
    ...
    let distance_metric: DistanceMetricKind =
