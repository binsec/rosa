...
use crate::fuzzer::{FuzzerBackend, config::FuzzerConfig};
...
pub struct Config {
    ...
    pub oracle_distance_metric: DistanceMetricKind,
}
...
impl Config {
    ...
    pub const fn default_cluster_formation_distance_metric() -> DistanceMetricKind {
        DistanceMetricKind::Hamming(Hamming)
    }
    ...
    pub const fn default_cluster_selection_distance_metric() -> DistanceMetricKind {
        DistanceMetricKind::Hamming(Hamming)
    }
    /// The default oracle algorithm.
    pub const fn default_oracle() -> OracleKind {
        OracleKind::CompMinMax(CompMinMax)
    }
    ...
    pub const fn default_oracle_distance_metric() -> DistanceMetricKind {
        DistanceMetricKind::Hamming(Hamming)
    }
